  ...
  return (
    <>
      <div className='flex'>
        ...
        <div className='w-[78%] h-[99vh] overflow-y-auto border-l-[1px] border-[#D3D3D3] px-[68px] pt-[52px]'>
          <DashboardHeader title={t('dashboard.profile.title')} language={language} handleLanguageChange={handleLanguageChange} languageOptions={languageOptions} />
          <div>
            ...
            <div className='flex items-center gap-[30px] mt-[32px]'>
              <label className={`w-[153px] px-[3px] py-[8px] text-center border-[1px] border-[#1E90FFCC] rounded-[8px]`}>
          ...
          <div className='mt-[32px] mb-[123px]'>
            ...
            <form className='flex items-center flex-wrap gap-[75px]'>
              ...
              <label className='flex flex-col'>
                ...
                <select className='w-[254px] py-[12px] pl-[15px] pr-[4px] mt-[10px] rounded-[12px] bg-transparent outline-none border-[2px] border-[#979797] focus:border-[#1E90FFCC] placeholder:text-black text-black focus:text-[#1E90FFCC]'>
                  <option value="" disabled defaultValue={t('dashboard.profile.genderPlaceholder')}>{t('dashboard.profile.genderPlaceholder')}</option>
              ...
              <label className='flex flex-col'>
                ...
                <select className='w-[254px] py-[12px] pl-[15px] pr-[15px] mt-[10px] rounded-[12px] bg-transparent outline-none border-[2px] border-[#979797] focus:border-[#1E90FFCC] placeholder:text-black focus:text-[#1E90FFCC]' type="select" placeholder={t('dashboard.profile.regionPlaceholder')} aria-label='Your Name' >
                  <option value="" disabled defaultValue={t('dashboard.profile.regionPlaceholder')}>{t('dashboard.profile.regionPlaceholder')}</option>
