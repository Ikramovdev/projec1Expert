        ...
        <section id='works' className='mb-[220px] works'>
            <div className='w-[1141px] mx-auto'>
                <div className='relative'>
                    <h2 className='font-bold text-[36px] leading-[40px] text-[#0F172A] text-center'>{t('works.title')}</h2>
                    ...
                    <div className={`absolute top-[38%] ${isRussian ? 'left-[-3%]' : 'left-0'} text-center`}>
                        <p className='font-regular text-[26px] leading-[40px] text-black mb-[23px]'>{t('works.leftText1')}</p>
                        <img className='mx-auto mb-[25px]' src={BottomStrelka} alt="BottomStrelka" width={10} height={59} />
                        <p className='font-regular text-[26px] leading-[40px] text-black'>{t('works.leftText2')}</p>
                    </div>
                    ...
                    <div className={`absolute top-[38%] ${isRussian ? 'right-[-3%]' : 'right-0'} text-center`}>
                        <p className='font-regular text-[26px] leading-[40px] text-black mb-[23px]'>{t('works.rightText1')}</p>
                        <img className='mx-auto mb-[25px]' src={BottomStrelka} alt="BottomStrelka" width={10} height={59} />
                        <p className='font-regular text-[26px] leading-[40px] text-black'>{t('works.rightText2')}</p>
                    </div>
                </div>
            </div>
        </section>
