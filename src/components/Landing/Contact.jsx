  ...
  return (
    <section id='contact' className='mb-[68px] contactBottom'>
      <div className='w-[1157px] mx-auto'>
        <h2 className='font-bold text-[36px] leading-[40px] text-[#0F172A] text-center mb-[120px]'>{t('landing.contact.title')}</h2>
          ...
          <div className='w-[1121px] border-[2px] border-b-0 contact border-black pt-[45px] pb-[38px] pl-[67px] pr-[45px] rounded-tl-[17px] rounded-tr-[17px] flex justify-between'>
            <div>
              <div className='w-[416px] mb-[103px]'>
                <h3 className='font-bold text-[36px] leading-[40px] ml-[25px] text-[#0F172A] mb-[23px]'>{t('landing.contact.leftText1')}</h3>
              ...
              <form className='flex flex-col'>
                <p className='font-bold text-[24px] leading-[36px] text-[#414141] mb-[23px]'>{t('landing.contact.leftText2')}</p>
                <label className='w-[423px] flex flex-col gap-[5px] mb-[26px]'>
                  <p className='font-regular text-[14px] leading-[32px] ml-[22px] text-[#A7A7A7]'>{t('landing.contact.leftText3')}</p>
                ...
                <label className='w-[423px] flex flex-col gap-[5px] mb-[14px]'>
                  <p className='font-regular text-[14px] leading-[32px] ml-[22px] text-[#A7A7A7]'>{t('landing.contact.leftText4')}</p>
                ...
                <label className='w-[423px] flex flex-col gap-[5px]'>
                  <p className='font-regular text-[14px] leading-[32px] ml-[22px] text-[#A7A7A7]'>{t('landing.contact.leftText5')}</p>
                ...
                <button className='w-[169px] py-[8px] border-[2px] border-black font-bold text-[16px] leading-[32px] text-black rounded-[17px] ml-[23px] mt-[53px] hover:bg-[#1E90FF] hover:border-transparent hover:text-white duration-300'>{t('landing.contact.leftText7')}</button>
              </form>
            </div>
            <div className='flex flex-col'>
              ...
              <ul className='flex flex-col gap-[50px] mt-[20px]'>
                <li className='flex items-center gap-[40px]'>
                  <LocationIcon />
                  <p className='font-regular text-[14px] leading-[20px] text-black'>{t('landing.contact.rightText1')}</p>
                </li>
                <li className='flex items-center gap-[40px]'>
                  <CallIcon />
